...
if __name__ == "__main__":
    ...
    parser.add_argument('set_path', nargs='?', default='testGT', help='Set on which the run has been done (per default test but you may run some checks on your validation and train sets too)')
